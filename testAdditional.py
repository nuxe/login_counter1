...
class TestAddUser(testLib.RestTestCase):
    ...
    def testAdd6(self):
        respData = self.makeRequest("/users/add", method="POST", data = { 'user' : 'user123user123user123user123user123user123user123user123user123user123user123user123user123user123user123user123user123user123user123', 'password' : 'password'} )
        self.assertResponse(respData, None, errCode = -3)
