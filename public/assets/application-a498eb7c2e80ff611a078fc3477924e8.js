...
$(document).ready(function () {
	...
	$("#logout_button").click(function () {
		$("#top_message").text("Please Enter Your Name/Credentials Below");
		$("#bottom_message").text("AHAHA");
		$("#Blabla").show()
		$("#user_user").val("")
		$("#user_password").val("")
		$("#logout_button").hide();
	...
	function sendAjax (url) {
		...
		request = $.ajax({
	          ...
	          success: function  (argument) {
	          	handleResponse(userName, argument)
	          }
	    });
	}

	function handleResponse (userName, data) {
		...
		if (errCode == 1) {
			...
			var count = data["count"];
			output = "You have logged in  " + count + " times.";
			$("#bottom_message").text(output);
			output = "Welcome " + userName
			$("#Blabla").hide()
			$("#logout_button").show()
			...
			output = "The user name should be non-empty and at most 128 characters long. Please try again.";
		} else if (errCode == -4) {
			output = "The password should be at most 128 characters long. Please try again.";
		}
